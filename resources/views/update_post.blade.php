<div class="container">
    ...
    <form id="samll_form" action="<?php echo route('updatePostDB') ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" name="post_title" class="form-control" id="inputEmail3" placeholder="Post Title"
                    value="<?php echo $post->post_title ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="exampleFormControlTextarea1">Post Description</label>
            <textarea name="post_desc" class="form-control" id="exampleFormControlTextarea1" rows="3" value=""><?php echo $post->post_description ?></textarea>
        </div>
